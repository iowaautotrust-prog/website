      ...
      <div className="max-w-2xl mx-auto p-8 bg-white min-h-screen font-sans text-gray-900">
        ...
        <div className="flex items-start justify-between mb-8 pb-6 border-b-2 border-gray-900">
          <div>
            ...
            <p className="text-sm text-gray-600">iowatrustmotors@gmail.com</p>
          </div>
        ...
        <div className="border-t border-gray-200 pt-6 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Questions? Call us at (515) 672-5406 or email iowatrustmotors@gmail.com</p>
        </div>
      </div>
    </>
  );
